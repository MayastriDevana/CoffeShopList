...
struct CoffeeshopProvider {
    static func allData() -> [Coffeeshop] {
        let coffeeshopData = [
            Coffeeshop(name: "Casadela Coffee", 
                       description: "Casadela is more than just a coffee shop. It's a place where you can relax, chat, work, or read in a comfortable and friendly atmosphere.", location: "Jl. Kemunging, Kota Bandung",
                       image: "casadela",
                       overview: """
